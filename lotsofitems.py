...
# Create dummy user
User1 = User(name="Girum Hagos", email="girumatakilti@yahoo.com", picture='https://pbs.twimg.com/profile_images/2671170543/18debd694829ed78203a5a36dd364160_400x400.png')
session.add(User1)
session.commit()
